...
type Querier interface {
	...
	SearchArtifacts(ctx context.Context, arg SearchArtifactsParams) ([]Artifact, error)
	SearchMemoryItems(ctx context.Context, arg SearchMemoryItemsParams) ([]MemoryItem, error)
